...
public class ModifyProjectParameterize {
	...
	private static void minimizFlyoutWindow()
	{
     ...
     {
    	 return new Object[][] {{"It is a selenium related programs"}};
     }
     @Test(priority=7,dataProvider="getModify")
     private static void modifyproject(String dss )
     {
     	try
     	{
     		oPage.getModify1().click();
     		Thread.sleep(1000);
     		oPage.getModify2().clear();
     		Thread.sleep(1000);
     		oPage.getModify3().sendKeys(dss);
     		Thread.sleep(1000);
     		oPage.getModify4().click();
     		Thread.sleep(1000);
    	   	}catch(Exception e)
     	{
     		e.printStackTrace();
